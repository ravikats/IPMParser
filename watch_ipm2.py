...
def write_outputs(filename, out_dir, metadata_dir, rules_path, errors_only=False):
...
class Watcher:
    def __init__(self, watch_dir, out_dir, prefix, metadata_dir, rules_path, interval, errors_only=False):
